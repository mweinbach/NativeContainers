...
| GUI Linux virtual machines | ISO selection/copy, create, selection versus runtime actions, install console, rename, compute and network configuration, shared folders, pause/resume/suspend/restore/Start Fresh/Discard Saved State/shutdown/Force Stop/eject, clone, export/import and delete | Open |
| macOS virtual machines | IPSW download/import, prepare/install, selection versus runtime actions, console, saved state, rename, compute, disk and snapshots, shares, audio, network, USB, clone, export/import and delete | Open |
