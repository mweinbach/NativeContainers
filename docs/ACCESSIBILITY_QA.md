...
| GUI Linux virtual machines | ISO selection/copy, create, selection versus runtime actions, install console, configuration, shared folders, pause/resume/shutdown/Force Stop/eject, clone, export/import and delete | Open |
