...
| GUI Linux virtual machines | ISO selection/copy, create, selection versus runtime actions, install console, rename, compute/network/disk-growth configuration, disk snapshots, shared folders, pause/resume/suspend/restore/Start Fresh/Discard Saved State/shutdown/Force Stop/eject, clone, export/import and delete | Open |
